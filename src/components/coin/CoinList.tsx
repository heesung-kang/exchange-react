    ...
    >
      <div className={styles.infoWrap}>
        <div className={styles.coinImg}>
          {abbr === 'INC' ? (
            <img src={`${import.meta.env.BASE_URL}images/simbol_inc.svg`} alt={abbr} />
          ) : abbr === 'BTC' ? (
            <img src={`${import.meta.env.BASE_URL}images/simbol_btc.svg`} alt={abbr} />
          ) : (
            <img src={`${import.meta.env.BASE_URL}images/simbol_eth.svg`} alt={abbr} />
          )}
        </div>
