        ...
        <section className={styles.termsBody}>
          <div className={styles.termsBodyWrap}>
            ...
            <ol className={styles.sent}>
              <li>
                “서비스”란 회사가 디지털 가상 자산을 특정 이용자에게 개별적으로 판매하기 위하여 컴퓨터 등 정보통신설비를 이용하여 제공하는 제반
                서비스를 말한다.
              </li>
              ...
              <li>“시세”(환전비율? 교환비율?)란…</li>
            </ol>

            <h2>제3조 (약관의 게시와 개정)</h2>
            <ol className={styles.sent}>
              <li>회사는 이 약관의 내용을 회원이 쉽게 알 수 있도록 서비스 내 화면 또는 연결화면을 통하여 게시합니다.</li>
              <li>회사는 필요한 경우 관련 법령을 위배하지 않는 범위에서 이 약관을 개정할 수 있습니다.</li>
              <li>
                회사가 이 약관을 개정할 경우에는 개정내용과 적용일자를 명시하여 적용일자 30일 이전부터 적용일자 전날까지 회원에게 공지 또는
                통지합니다.
              </li>
              <li>
            ...
            <ol className={styles.sent}>
              ...
              <li>
                “회사”은 재화, 용역 및 서비스의 품절 또는 기술적 사양의 변경 등의 경우에는 장차 체결되는 계약에 의해 제공할 재화, 용역 및 서비스의
                내용을 변경할 수 있습니다. 이 경우에는 변경된 재화 또는 용역의 내용 및 제공일자를 명시하여 현재의 재화 또는 용역의 내용을 게시한 곳에
                즉시 공지한다.
              </li>
              <li>
                “회사”가 제공하기로 이용자와 계약을 체결한 서비스의 내용을 재화 등의 품절 또는 기술적 사양의 변경 등의 사유로 변경할 경우에는 그
                사유를 이용자에게 통지 가능한 주소로 즉시 통지한다.
              </li>
              <li>
                전항의 경우 “회사”은 이로 인하여 이용자가 입은 손해를 배상한다. 다만, “회사”가 고의 또는 과실이 없음을 입증하는 경우에는 그러하지
                아니한다.
              </li>
            </ol>
            ...
            <ol className={styles.sent}>
              <li>
                ...
                교환비율을 적용하여 계산한 수량을 실시간으로 계산하여 화면에 표시합니다.
              </li>
              <li>
                회원이 본 이용약관에 동의함을 표시하고 구매 버튼을 누르면 회사는 인스타페이 앱으로 결제 가능한 QR코드(PC의 경우)나 앱 결제 화면으로
                연결되는 링크(모바일의 경우)를 제공합니다. 회원이 QR코드를 스캔하거나 링크를 눌러 인스타페이 앱의 결제 화면으로 이동 후
                비밀번호(PIN)을 입력하면 구매를 위한 결제를 진행합니다.
              </li>
              <li>
                결제는 사전에 실명확인과 출금동의를 거친 회원 본인의 입출금 계정(같은 금융회사에 개설된 회사의 계좌와 회원의 계좌 사이에서만 금융거래
                등을 허용하는 계정을 말합니다)으로부터 1에서 설정한 금액을 출금함으로써 완료됩니다.
              </li>
              <li>인스타페이 앱으로 결제를 완료한 경우 회원은 디지털 자산 매매주문을 제출한 것으로 간주합니다.</li>
              <li>
                회사는 회원이 주문을 제출하기 전에 회원이 매수 또는 매도하려고 하는 디지털 자산의 수량, 가격 등을 요약한 주문확인 정보를 제공합니다.
                회원은 회사가 이러한 주문확인 정보를 제공하지 못하는 경우에도 회원이 제출한 주문에는 영향을 미치지 않음에 동의합니다.
              </li>
              <li>
                회원은 디지털 자산의 가격 변동에 대해서 회사가 책임지지 않는 것에 동의합니다. 디지털 자산 시장의 중단 또는 제20조 제2항의 사유가
                발생한 경우 회사는 다음 중 하나 이상의 조치를 수행할 수 있으며 이러한 조치로 인해서 회원에게 발생한 손실에 대해서 회사는 고의 또는
              ...
              <li>
                회원이 보유한 가상 자산에 대해서 회사에 출금을 요청하면, 회사는 해당 가산 자산을 회원의 (수식어 필요할 듯) 지갑에 전송합니다. 이때
                전송에 필요한 수수료는 회원이 부담합니다.
              </li>
            </ol>
            ...
            <ol className={styles.sent}>
              ...
              <li>
                “회사”는 제1항의 사유로 서비스의 제공이 일시적으로 중단됨으로 인하여 이용자 또는 제3자가 입은 손해에 대하여 배상한다. 단, “회사”가
                고의 또는 과실이 없음을 입증하는 경우에는 그러하지 아니한다.
              </li>
              <li>
                사업 종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 “회사”은 제8조에 정한 방법으로
                이용자에게 통지하고 당초 “회사”에서 제시한 조건에 따라 소비자에게 보상한다. 다만, “회사”가 보상기준 등을 고지하지 아니한 경우에는
                이용자들의 마일리지 또는 적립금 등을 “회사”에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급한다.
              </li>
            </ol>
            ...
            <ol className={styles.sent}>
              <li>“회사”는 회원에 대한 통지를 하는 경우, 회원이 “회사”과 미리 약정하여 지정한 전자우편 주소로 할 수 있습니다.</li>
              <li>
                “회사”는 불특정다수 회원에 대한 통지의 경우 1주일이상 “회사” 게시판에 게시함으로서 개별 통지에 갈음할 수 있습니다. 다만, 회원 본인의
            ...
            <h2>제10조(개인정보보호)</h2>
            <ol className={styles.sent}>
              <li>“회사”는 이용자의 개인정보 수집시 서비스제공을 위하여 필요한 범위에서 최소한의 개인정보를 수집한다.</li>
              <li>
                “회사”는 회원 가입시 구매계약이행에 필요한 정보를 미리 수집하지 않습니다. 다만, 관련 법령상 의무이행을 위하여 구매계약 이전에
              ...
              <li>
                ...
                이용·제공단계에서 당해 이용자에게 그 목적을 고지하고 동의를 받습니다. 다만, 관련 법령에 달리 정함이 있는 경우에는 예외로 한다.
              </li>
              <li>
              ...
              <li>
                이용자는 언제든지 “회사”가 가지고 있는 자신의 개인정보에 대해 열람 및 오류정정을 요구할 수 있으며 “회사”은 이에 대해 지체 없이 필요한
                조치를 취할 의무를 집니다. 이용자가 오류의 정정을 요구한 경우에는 “회사”은 그 오류를 정정할 때까지 당해 개인정보를 이용하지 않습니다.
              </li>
              <li>
                “회사”는 개인정보 보호를 위하여 이용자의 개인정보를 처리하는 자를 최소한으로 제한하여야 하며 신용카드, 은행계좌 등을 포함한 이용자의
            ...
            <ol className={styles.sent2}>
              ...
              <li>g. 외설 또는 폭력적인 메시지, 화상, 음성, 기타 공서양속에 반하는 정보를 몰에 공개 또는 게시하는 행위</li>
            </ol>
